    ...
    return (
        <div className={`fixed inset-y-0 right-0 w-96 bg-white text-gray-500 border border-gray-300 transform ${
            ...
            <nav className="mt-10">
                ...
                <a href="/pay-loan" className="block text-center py-2.5 px-4 my-5 rounded transition duration-200 hover:bg-sky-400 hover:text-white">
                Pay Loan
                </a>
                <a href="/add-debit" className="block text-center py-2.5 px-4 my-5 rounded transition duration-200 hover:bg-sky-400 hover:text-white">
                    New Debit
                </a>
                <a href="/add-credit" className="block text-center py-2.5 px-4 my-5 rounded transition duration-200 hover:bg-sky-400 hover:text-white">
                    New Credit
                </a>
            </nav>
